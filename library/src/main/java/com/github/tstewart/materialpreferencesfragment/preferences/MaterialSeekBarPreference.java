...
public class MaterialSeekBarPreference extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    public MaterialSeekBarPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.MaterialSeekBarPreference);
        try {
            mShowSign = a.getBoolean(R.styleable.MaterialSeekBarPreference_showSign, mShowSign);
            String units = a.getString(R.styleable.MaterialSeekBarPreference_units);
            if (units != null)
                mUnits = " " + units;
            mContinuousUpdates = a.getBoolean(R.styleable.MaterialSeekBarPreference_continuousUpdates, mContinuousUpdates);
            String defaultValueText = a.getString(R.styleable.MaterialSeekBarPreference_defaultValueText);
        ...
        setLayoutResource(R.layout.material_seekbar_preference);
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        try
        {
            ...
            if (oldContainer != newContainer) {
                ...
                // remove the existing seekbar (there may not be one) and this one
        ...
        mResetImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(getContext(), getContext().getString(R.string.material_seekbar_default_value_to_set, getTextValue(mDefaultValue)),
            ...
            if (!mTrackingTouch || mContinuousUpdates) {
                if (mDefaultValueTextExists && mDefaultValueExists && mValue == mDefaultValue) {
                    mValueTextView.setText(mDefaultValueText + " (" +
                            getContext().getString(R.string.material_seekbar_default_value) + ")");
                } else {
                    mValueTextView.setText(getContext().getString(R.string.material_seekbar_value, getTextValue(mValue)) +
                ...
                if (mDefaultValueTextExists && mDefaultValueExists && mTrackingValue == mDefaultValue) {
                    ...
                    mValueTextView.setText(getContext().getString(R.string.material_seekbar_value, "[" + getTextValue(mTrackingValue) + "]"));
                }
            }
        }
        if (mResetImageView != null) {
